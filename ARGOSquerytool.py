...
#
# Created by: Isabel Hillman (isabel.hillman@duke.edu)
# Created on: Sept, 2018


#adding in script for 3.3
...
#the things in the parentheses above will populate in the brackets

#to read the file used fileObj = open('sara.txt', 'r')
